...
public class SeedLocationMapperPart2
{
    public static void main(String[] args)
    {
        String filePath = "/Users/manjula/Desktop/hackathon/adventofcode/src/day5/input";
    ...
    public static String[] splitSeeds(final String seedsString)
    {
        ...
        for (int i = 0; i <seedNumbers.length ;)
        {
            expandedList.add(seedNumbers[i]);
            for (int j = 0; j <= Long.parseLong(seedNumbers[i+1]); j++)
            {
                expandedList.add(String.valueOf(Long.parseLong(seedNumbers[i])+j));
            }
            i=i+2;
        }
